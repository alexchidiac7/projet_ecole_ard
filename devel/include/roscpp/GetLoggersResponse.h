...
struct GetLoggersResponse_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::roscpp::Logger_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::roscpp::Logger_<ContainerAllocator> >> _loggers_type;
