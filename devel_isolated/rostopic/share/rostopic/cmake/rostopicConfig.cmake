...
if("TRUE" STREQUAL "TRUE")
  set(rostopic_SOURCE_PREFIX /home/pi/ros_catkin_ws/src/ros_comm/rostopic)
  set(rostopic_DEVEL_PREFIX /home/pi/ros_catkin_ws/devel_isolated/rostopic)
  set(rostopic_INSTALL_PREFIX "")
  set(rostopic_PREFIX ${rostopic_DEVEL_PREFIX})
else()
  set(rostopic_SOURCE_PREFIX "")
  set(rostopic_DEVEL_PREFIX "")
  set(rostopic_INSTALL_PREFIX /opt/ros/melodic)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rostopic' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/ros_catkin_ws/src/ros_comm/rostopic/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/ros_catkin_ws/devel_isolated/rostopic/lib;/opt/ros/melodic/lib)
...
foreach(depend ${depends})
  ...
  list(APPEND rostopic_EXPORTED_TARGETS ${${rostopic_dep}_EXPORTED_TARGETS})
endforeach()
