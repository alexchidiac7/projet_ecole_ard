...
#if defined(_WIN32) && defined(TERMINATE_SUCCESS)
  #undef TERMINATE_SUCCESS
#endif
#if defined(_WIN32) && defined(TERMINATE_ABORTED)
  #undef TERMINATE_ABORTED
#endif
#if defined(_WIN32) && defined(TERMINATE_REJECTED)
  #undef TERMINATE_REJECTED
#endif
#if defined(_WIN32) && defined(TERMINATE_LOSE)
  #undef TERMINATE_LOSE
#endif
#if defined(_WIN32) && defined(TERMINATE_DROP)
  #undef TERMINATE_DROP
#endif
#if defined(_WIN32) && defined(TERMINATE_EXCEPTION)
  #undef TERMINATE_EXCEPTION
#endif
...
bool operator==(const ::actionlib::TestRequestGoal_<ContainerAllocator1> & lhs, const ::actionlib::TestRequestGoal_<ContainerAllocator2> & rhs)
{
  return lhs.terminate_status == rhs.terminate_status &&
    lhs.ignore_cancel == rhs.ignore_cancel &&
    lhs.result_text == rhs.result_text &&
    lhs.the_result == rhs.the_result &&
    lhs.is_simple_client == rhs.is_simple_client &&
    lhs.delay_accept == rhs.delay_accept &&
    lhs.delay_terminate == rhs.delay_terminate &&
