// Generated by gencpp from file std_srvs/TriggerRequest.msg
// DO NOT EDIT!


#ifndef STD_SRVS_MESSAGE_TRIGGERREQUEST_H
#define STD_SRVS_MESSAGE_TRIGGERREQUEST_H
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::std_srvs::TriggerRequest_<ContainerAllocator> >
  {
...
{
  template<typename Stream> static void stream(Stream&, const std::string&, const ::std_srvs::TriggerRequest_<ContainerAllocator>&)
  {}
};
