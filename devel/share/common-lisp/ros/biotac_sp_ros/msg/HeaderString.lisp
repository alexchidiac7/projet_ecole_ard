...
(cl:in-package biotac_sp_ros-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <HeaderString>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HeaderString)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name biotac_sp_ros-msg:<HeaderString> is deprecated: use biotac_sp_ros-msg:HeaderString instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <HeaderString>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader biotac_sp_ros-msg:header-val is deprecated.  Use biotac_sp_ros-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <HeaderString>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader biotac_sp_ros-msg:data-val is deprecated.  Use biotac_sp_ros-msg:data instead.")
  (data m))
