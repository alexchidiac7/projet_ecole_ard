...
echo_and_run cd "/home/pi/ros_catkin_ws/src/biotac_sp_ros/biotac_log_parser"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/pi/ros_catkin_ws/src/biotac_sp_ros/biotac_log_parser/setup.py" \
     \
    build --build-base "/home/pi/ros_catkin_ws/build/biotac_sp_ros/biotac_log_parser" \
    install \
    --root="${DESTDIR-/}" \
