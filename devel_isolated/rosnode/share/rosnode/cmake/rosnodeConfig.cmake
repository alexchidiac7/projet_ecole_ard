...
if("TRUE" STREQUAL "TRUE")
  set(rosnode_SOURCE_PREFIX /home/pi/ros_catkin_ws/src/ros_comm/rosnode)
  set(rosnode_DEVEL_PREFIX /home/pi/ros_catkin_ws/devel_isolated/rosnode)
  set(rosnode_INSTALL_PREFIX "")
  set(rosnode_PREFIX ${rosnode_DEVEL_PREFIX})
else()
  set(rosnode_SOURCE_PREFIX "")
  set(rosnode_DEVEL_PREFIX "")
  set(rosnode_INSTALL_PREFIX /opt/ros/melodic)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosnode' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/ros_catkin_ws/src/ros_comm/rosnode/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/ros_catkin_ws/devel_isolated/rosnode/lib;/opt/ros/melodic/lib)
...
foreach(depend ${depends})
  ...
  list(APPEND rosnode_EXPORTED_TARGETS ${${rosnode_dep}_EXPORTED_TARGETS})
endforeach()
