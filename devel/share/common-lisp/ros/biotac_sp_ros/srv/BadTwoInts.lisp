...
(cl:in-package biotac_sp_ros-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <BadTwoInts-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BadTwoInts-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name biotac_sp_ros-srv:<BadTwoInts-request> is deprecated: use biotac_sp_ros-srv:BadTwoInts-request instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <BadTwoInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader biotac_sp_ros-srv:a-val is deprecated.  Use biotac_sp_ros-srv:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <BadTwoInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader biotac_sp_ros-srv:b-val is deprecated.  Use biotac_sp_ros-srv:b instead.")
  (b m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BadTwoInts-request>)))
  ...
  "biotac_sp_ros/BadTwoIntsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BadTwoInts-request)))
  "Returns string type for a service object of type 'BadTwoInts-request"
  "biotac_sp_ros/BadTwoIntsRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<BadTwoInts-request>)))
  ...
  (cl:format cl:nil "# Bad version of AddTwoInts for unit testing~%int64 a~%int32 b~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'BadTwoInts-request)))
  "Returns full string definition for message of type 'BadTwoInts-request"
  (cl:format cl:nil "# Bad version of AddTwoInts for unit testing~%int64 a~%int32 b~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <BadTwoInts-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BadTwoInts-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name biotac_sp_ros-srv:<BadTwoInts-response> is deprecated: use biotac_sp_ros-srv:BadTwoInts-response instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <BadTwoInts-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader biotac_sp_ros-srv:sum-val is deprecated.  Use biotac_sp_ros-srv:sum instead.")
  (sum m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BadTwoInts-response>)))
  ...
  "biotac_sp_ros/BadTwoIntsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BadTwoInts-response)))
  "Returns string type for a service object of type 'BadTwoInts-response"
  "biotac_sp_ros/BadTwoIntsResponse")
