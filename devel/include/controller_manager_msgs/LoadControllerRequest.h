...
bool operator==(const ::controller_manager_msgs::LoadControllerRequest_<ContainerAllocator1> & lhs, const ::controller_manager_msgs::LoadControllerRequest_<ContainerAllocator2> & rhs)
{
