...
bool operator==(const ::controller_manager_msgs::SwitchControllerResponse_<ContainerAllocator1> & lhs, const ::controller_manager_msgs::SwitchControllerResponse_<ContainerAllocator2> & rhs)
{
