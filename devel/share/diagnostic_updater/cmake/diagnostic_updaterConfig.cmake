...
if("TRUE" STREQUAL "TRUE")
  set(diagnostic_updater_SOURCE_PREFIX /home/pi/ros_catkin_ws/src/diagnostics/diagnostic_updater)
  set(diagnostic_updater_DEVEL_PREFIX /home/pi/ros_catkin_ws/devel)
  ...
  set(diagnostic_updater_INSTALL_PREFIX /home/pi/ros_catkin_ws/install)
...
if(NOT "/home/pi/ros_catkin_ws/src/diagnostics/diagnostic_updater/include " STREQUAL " ")
  set(diagnostic_updater_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/ros_catkin_ws/src/diagnostics/diagnostic_updater/include")
  if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://www.ros.org/wiki/diagnostic_updater " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Austin Hendrix <namniart@gmail.com>, Brice Rebsamen <brice.rebsamen@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'diagnostic_updater' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/ros_catkin_ws/src/diagnostics/diagnostic_updater/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND diagnostic_updater_EXPORTED_TARGETS ${${diagnostic_updater_dep}_EXPORTED_TARGETS})
endforeach()
