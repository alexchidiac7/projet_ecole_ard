...
echo_and_run cd "/home/pi/ros_catkin_ws/src/biotac_driver/rosjson_time"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/pi/ros_catkin_ws/src/biotac_driver/rosjson_time/setup.py" \
     \
    build --build-base "/home/pi/ros_catkin_ws/build/biotac_driver/rosjson_time" \
    install \
    --root="${DESTDIR-/}" \
