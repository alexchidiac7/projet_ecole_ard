...
struct State_
{
  ...
  _rumble_type rumble;
   ...
   typedef std::vector< ::wiimote::IrSourceInfo_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::wiimote::IrSourceInfo_<ContainerAllocator> >> _ir_tracking_type;
