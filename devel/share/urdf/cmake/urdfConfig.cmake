...
if("TRUE" STREQUAL "TRUE")
  set(urdf_SOURCE_PREFIX /home/pi/ros_catkin_ws/src/urdf/urdf)
  set(urdf_DEVEL_PREFIX /home/pi/ros_catkin_ws/devel)
  set(urdf_INSTALL_PREFIX "")
  set(urdf_PREFIX ${urdf_DEVEL_PREFIX})
else()
  set(urdf_SOURCE_PREFIX "")
  set(urdf_DEVEL_PREFIX "")
  set(urdf_INSTALL_PREFIX /home/pi/ros_catkin_ws/install)
...
if(NOT "/home/pi/ros_catkin_ws/src/urdf/urdf/include;/home/pi/ros_catkin_ws/devel/include;/usr/include " STREQUAL " ")
  set(urdf_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/ros_catkin_ws/src/urdf/urdf/include;/home/pi/ros_catkin_ws/devel/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'urdf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/ros_catkin_ws/src/urdf/urdf/${idir}'.  ${_report}")
    endif()
    _list_append_unique(urdf_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "urdf;/usr/lib/arm-linux-gnueabihf/liburdfdom_sensor.so;/usr/lib/arm-linux-gnueabihf/liburdfdom_model_state.so;/usr/lib/arm-linux-gnueabihf/liburdfdom_model.so;/usr/lib/arm-linux-gnueabihf/liburdfdom_world.so;/usr/lib/arm-linux-gnueabihf/libconsole_bridge.so.0.4;/usr/lib/arm-linux-gnueabihf/libboost_thread.so;-pthread;/usr/lib/arm-linux-gnueabihf/libboost_chrono.so;/usr/lib/arm-linux-gnueabihf/libboost_system.so;/usr/lib/arm-linux-gnueabihf/libboost_date_time.so;/usr/lib/arm-linux-gnueabihf/libboost_atomic.so;/usr/lib/arm-linux-gnueabihf/libtinyxml.so;/usr/lib/arm-linux-gnueabihf/libtinyxml2.so")
...
foreach(depend ${depends})
  ...
  list(APPEND urdf_EXPORTED_TARGETS ${${urdf_dep}_EXPORTED_TARGETS})
endforeach()
