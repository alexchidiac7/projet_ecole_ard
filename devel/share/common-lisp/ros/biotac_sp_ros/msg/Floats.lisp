...
(cl:defmethod cl:initialize-instance :after ((m <Floats>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Floats)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name biotac_sp_ros-msg:<Floats> is deprecated: use biotac_sp_ros-msg:Floats instead.")))
