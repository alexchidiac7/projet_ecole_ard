...
struct ControllerState_
{
  ...
  _type_type type;
   ...
   typedef std::vector< ::controller_manager_msgs::HardwareInterfaceResources_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::controller_manager_msgs::HardwareInterfaceResources_<ContainerAllocator> >> _claimed_resources_type;
...
bool operator==(const ::controller_manager_msgs::ControllerState_<ContainerAllocator1> & lhs, const ::controller_manager_msgs::ControllerState_<ContainerAllocator2> & rhs)
{
  return lhs.name == rhs.name &&
    lhs.state == rhs.state &&
    lhs.type == rhs.type &&
    lhs.claimed_resources == rhs.claimed_resources;
}
