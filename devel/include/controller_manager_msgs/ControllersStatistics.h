...
struct ControllersStatistics_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::controller_manager_msgs::ControllerStatistics_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::controller_manager_msgs::ControllerStatistics_<ContainerAllocator> >> _controller_type;
...
bool operator==(const ::controller_manager_msgs::ControllersStatistics_<ContainerAllocator1> & lhs, const ::controller_manager_msgs::ControllersStatistics_<ContainerAllocator2> & rhs)
{
