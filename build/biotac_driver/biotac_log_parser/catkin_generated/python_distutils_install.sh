...
echo_and_run cd "/home/pi/ros_catkin_ws/src/biotac_driver/biotac_log_parser"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/pi/ros_catkin_ws/src/biotac_driver/biotac_log_parser/setup.py" \
     \
    build --build-base "/home/pi/ros_catkin_ws/build/biotac_driver/biotac_log_parser" \
    install \
    --root="${DESTDIR-/}" \
