...
struct ListControllerTypesResponse_
{
  ...
  _types_type types;
   ...
   typedef std::vector<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>> _base_classes_type;
...
bool operator==(const ::controller_manager_msgs::ListControllerTypesResponse_<ContainerAllocator1> & lhs, const ::controller_manager_msgs::ListControllerTypesResponse_<ContainerAllocator2> & rhs)
{
  return lhs.types == rhs.types &&
    lhs.base_classes == rhs.base_classes;
}
...
struct Printer< ::controller_manager_msgs::ListControllerTypesResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::controller_manager_msgs::ListControllerTypesResponse_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.base_classes.size(); ++i)
    {
      ...
      Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.base_classes[i]);
    }
  }
};
