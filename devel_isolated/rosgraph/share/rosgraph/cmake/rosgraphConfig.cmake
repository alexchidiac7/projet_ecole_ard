...
if("TRUE" STREQUAL "TRUE")
  set(rosgraph_SOURCE_PREFIX /home/pi/ros_catkin_ws/src/ros_comm/rosgraph)
  set(rosgraph_DEVEL_PREFIX /home/pi/ros_catkin_ws/devel_isolated/rosgraph)
  set(rosgraph_INSTALL_PREFIX "")
  set(rosgraph_PREFIX ${rosgraph_DEVEL_PREFIX})
else()
  set(rosgraph_SOURCE_PREFIX "")
  set(rosgraph_DEVEL_PREFIX "")
  set(rosgraph_INSTALL_PREFIX /opt/ros/melodic)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosgraph' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/ros_catkin_ws/src/ros_comm/rosgraph/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/ros_catkin_ws/devel_isolated/rosgraph/lib;/opt/ros/melodic/lib)
