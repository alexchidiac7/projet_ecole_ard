...
struct ListControllersResponse_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::controller_manager_msgs::ControllerState_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::controller_manager_msgs::ControllerState_<ContainerAllocator> >> _controller_type;
