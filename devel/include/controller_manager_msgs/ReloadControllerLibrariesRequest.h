...
bool operator==(const ::controller_manager_msgs::ReloadControllerLibrariesRequest_<ContainerAllocator1> & lhs, const ::controller_manager_msgs::ReloadControllerLibrariesRequest_<ContainerAllocator2> & rhs)
{
