...
bool operator==(const ::controller_manager_msgs::UnloadControllerRequest_<ContainerAllocator1> & lhs, const ::controller_manager_msgs::UnloadControllerRequest_<ContainerAllocator2> & rhs)
{
