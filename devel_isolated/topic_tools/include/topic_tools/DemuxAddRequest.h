// Generated by gencpp from file topic_tools/DemuxAddRequest.msg
// DO NOT EDIT!
...
bool operator==(const ::topic_tools::DemuxAddRequest_<ContainerAllocator1> & lhs, const ::topic_tools::DemuxAddRequest_<ContainerAllocator2> & rhs)
{
